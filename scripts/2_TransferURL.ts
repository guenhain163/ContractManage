import { Address, beginCell, contractAddress, toNano, Cell as TonCell, TonClient4 } from "@ton/ton";
import { buildOnchainMetadata } from "../utils/jetton-helpers";
import { printAddress, printHeader, printDeploy, printSeparator } from "../utils/print";
import { deploy } from "../utils/deploy";

import { ContractManager } from "../build/ContractManager/tact_ContractManager";
import { JettonDefaultWallet, storeTokenTransfer } from "../build/ContractManager/tact_JettonDefaultWallet";
...
(async () => {
    let contract_address = await ContractManager.fromAddress(jetton_minter_root);
