// import { Address, TonClient4, WalletContractV4, beginCell, contractAddress, fromNano, internal, toNano } from "@ton/ton";
...
// dotenv.config();
// // ========================================
// import { ContractManager, storeTokenTransfer } from "../build/ContractManager/tact_ContractManager";
// // ========================================

// let NewOnwer_Address = Address.parse("EQCZUERmve5FUsuHkT5VYzkn-nDnp150p23hvJ1_D25Ji1H_"); // 🔴 Owner should usually be the deploying wallet's address.
...
//     let max_supply = BigInt(Math.floor(Math.random() * 10000)); // 🔴 Set the specific total supply in nano

//     // Compute init data for deployment
//     // NOTICE: the parameters inside the init functions were the input for the contract address
//     // which means any changes will change the smart contract address as well.
//     let init = await ContractManager.init(wallet_contract.address, content, max_supply);
//     let jetton_masterWallet = contractAddress(workchain, init);
//     let contract_dataFormat = ContractManager.fromAddress(jetton_masterWallet);
